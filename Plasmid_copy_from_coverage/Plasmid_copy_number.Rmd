...
table_input_142 <- read.table(sep = "\t", header = FALSE, "142_coverage", na.strings=c("","NA"))
...
```{r data3, echo=FALSE}
# Rinse and repeat 
table_input_143 <- read.table(sep = "\t", header = FALSE, "143_coverage", na.strings=c("","NA"))
...
```{r data5, echo=FALSE}
table_input_440 <- read.table(sep = "\t", header = FALSE, "440_coverage", na.strings=c("","NA"))
...
table_input_440[which(table_input_440$V1==sumContigs_440[1,1]),2] <- "Chr"
table_input_440[which(table_input_440$V1==sumContigs_440[2,1]),2] <- "pADAP-type plasmid"

table_input_626 <- read.table(sep = "\t", header = FALSE, "626_coverage", na.strings=c("","NA"))
...
table_input_626[which(table_input_626$V1==sumContigs_626[1,1]),2] <- "Chr"
table_input_626[which(table_input_626$V1==sumContigs_626[2,1]),2] <- "pADAP-type plasmid"

table_input_1048 <- read.table(sep = "\t", header = FALSE, "1048_coverage", na.strings=c("","NA"))
...
table_input_1048[which(table_input_1048$V1==sumContigs_1048[1,1]),2] <- "Chr"
table_input_1048[which(table_input_1048$V1==sumContigs_1048[2,1]),2] <- "pADAP-type plasmid"

table_input_RM5 <- read.table(sep = "\t", header = FALSE, "RM5_coverage", na.strings=c("","NA"))
...
table_input_RM5[which(table_input_RM5$V1==sumContigs_RM5[1,1]),2] <- "Chr"
table_input_RM5[which(table_input_RM5$V1==sumContigs_RM5[2,1]),2] <- "pADAP-type plasmid"
table_input_RM5[which(table_input_RM5$V1==sumContigs_RM5[3,1]),2] <- "Secondary plasmid"
```
...
```{r data_combine, warnings=FALSE, error=FALSE, message=FALSE, results="hide"}
